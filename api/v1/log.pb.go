...
// Record represents a single log entry with a value and its offset position.
type Record struct {
...
// offset is the position the record was written to in the log
...
// offset is the position to read from in the log
...
const file_api_v1_log_proto_rawDesc = "" +
	...
	"\rProduceStream\x12\x16.log.v1.ProduceRequest\x1a\x17.log.v1.ProduceResponse\"\x00(\x010\x01B(Z&github.com/0xkimani/proglog/api/log_v1b\x06proto3"
